...
<div class='container mt-5'>
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 ">
                <h3 class="card-title text-center mb-3">Add New Coffee Item</h3>
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('coffees.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-floating">
                                <textarea id="description" style="min-height: 150px;" type="description"
                            ...
                            <div class="form-floating">
                                <input id="purchased_price" type="number"
                                    ...
                                    name="purchased_price" value="{{ old('purchased_price') }}" required
                                    autocomplete="purchased_price" autofocus>
